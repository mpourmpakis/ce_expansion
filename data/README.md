...
* experimental_hbe.csv
  * The preferred source of experimental bond dissociation energy.
  * Morse, M. D., *Clusters of transition-metal atoms.* Chem. Rev. 1986, 86 (6), 1049-1109.
* estimated_hbe.csv
  * If no experimental bond dissociation energy is present in `experimental_hbe.csv`, we look now in this table.
